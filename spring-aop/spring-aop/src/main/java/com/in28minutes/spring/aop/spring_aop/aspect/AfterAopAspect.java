...
public class AfterAopAspect {
	...
	@AfterReturning(value = "execution(* com.in28minutes.spring.aop.spring_aop.business.*.*(..))", returning = "result")
	public void afterReturning(JoinPoint joinPoint, Object result) {
		logger.info("{} returning with value : {}", joinPoint, result);
	}

	@AfterThrowing(value = "execution(* com.in28minutes.spring.aop.spring_aop.business.*.*(..))", throwing = "exception")
